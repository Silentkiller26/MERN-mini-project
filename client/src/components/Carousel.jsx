...
const CAROUSEL_DATA = [
  {
    url: 'https://authindia.com/wp-content/uploads/2020/01/oshin-khandelwal-OVpUFAvwhNA-unsplash.jpg',
  },
  {
    url: 'https://www.handsofgold.in/wp-content/uploads/2021/10/RUM06696-1.jpg',
  },
];
const Carousel = () => {
    ...
    <section className='h-carousel relative bg-red-300'>
      ...
      <div className='absolute h-full w-full top-0 left-0 flex flex-col justify-center items-center text-white uppercase px-4 text-center'>
        ...
        <p className='tracking-wider mb-16 text-md md:text-xl'>
          don't compromise on art! get flat 30% off for new users.
        </p>
        <Link
          to='categories'
          spy={true}
